...
public class Series extends TableImpl<SeriesRecord> {
     ...
     */
    public final TableField<SeriesRecord, Long> SERIES_ID = createField(DSL.name("series_id"), SQLDataType.BIGINT, this, "");
     ...
     */
    public final TableField<SeriesRecord, LocalDate> RELEASE_DATE = createField(DSL.name("release_date"), SQLDataType.LOCALDATE, this, "", new DateBinding());
